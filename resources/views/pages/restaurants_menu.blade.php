                ...
                <div class="col-md-10 col-sm-9">
                    ...
                    <div class="rating">
                        @for ($x = 0; $x < 5; $x++) @if ($x < $restaurant->review_avg)
                            ...
                            @endif
                            @endfor
                            (<small><a href="{{ URL::to('restaurants/' . $restaurant->restaurant_slug) }}"> Lihat
                                    {{ \App\Review::getTotalReview($restaurant->id) }} Penilaian </a></small>)
                    </div>
                    <div class="rstl_list_btn"><a href="{{ URL::to('restaurants/' . $restaurant->restaurant_slug) }}">Lihat Deskripsi</a></div>
                </div>
            </div>
        </div>
    </div>
