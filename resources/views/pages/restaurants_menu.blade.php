            ...
            <div class="container">
                <div id="sub_content" class="animated zoomIn">
                    ...
                    <div class="col-md-10 col-sm-9">
                        ...
                        <div class="rstl_list_btn"><a
                                href="{{ URL::to('restaurants/' . $restaurant->restaurant_slug) }}">View
                                Restaurant</a></div>
                    </div>
                </div>
            </div>
                                ...
                                <tbody>
                                    @foreach (\App\Menu::where('menu_cat', $cat->id)->orderBy('menu_name')->get() as $menu_item)
                                        <tr>
                                            <td>
                                                ...
                                                <div class="rstl_img"><a href="#menu_{{ $menu_item->id }}">
                                                        @if ($menu_item->menu_image)
                                                            <img
                                                                src="{{ URL::asset('upload/menu/' . $menu_item->menu_image . '-s.jpg') }}" />
                                                        @else
                                                ...
                                                <div id="menu_{{ $menu_item->id }}" class="modalDialog">
                                                    <div>
                                                        ...
                                                        @if ($menu_item->menu_image)
                                                            <img
                                                                src="{{ URL::asset('upload/menu/' . $menu_item->menu_image . '-b.jpg') }}" />
                                                        @else
                                                            <img src="{{ URL::asset('upload/menu_img_s.png') }}" />
                                                        @endif
                                                    </div>
                                            ...
                                            <td><strong>{{ getcong('currency_symbol') }}
                                                    {{ $menu_item->price }}.000</strong>
                                            </td>
                                            <td class="options">
                                                @if (Auth::check())
                                                    <a href="{{ URL::to('add_item/' . $menu_item->id) }}"><i
