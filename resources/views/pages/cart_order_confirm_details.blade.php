        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="box_style_2">
                    <h2 class="inner">Pesanan Anda Telah Terkonfirmasi</h2>
                    ...
                    <table class="table table-striped nomargin">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><strong class="pull-right">{{ getcong('currency_symbol') }}{{ $order_item->item_price }}.000</strong>
                                </td>
                            </tr>
                            @endforeach
                            ...
                            <tr>
                                ...
                                <td class="total_confirm"><span class="pull-right">{{ getcong('currency_symbol') }}{{ $price = DB::table('cart')->where('user_id', Auth::id())->sum('item_price') }}.000</span>
                                </td>
                            </tr>
