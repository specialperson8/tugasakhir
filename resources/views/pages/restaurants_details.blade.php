        ...
        <div class="box_style_2">
            ...
            <div id="rating_summary" class="row">
              <div class="col-md-6">
                <ul>
                  <li>Food Quality
                    <div class="rating">
                      @for($x = 0; $x < 5; $x++) @if($x < DB::table('restaurant_review')->where('restaurant_id', $restaurant->id)->avg('food_quality'))
                        <i class="fa fa-star"></i>
                        @else
                        <i class="fa fa-star fa fa-star-o"></i>
                        @endif
                  ...
                  <li>Price
                    <div class="rating">
                      @for($x = 0; $x < 5; $x++) @if($x < DB::table('restaurant_review')->where('restaurant_id', $restaurant->id)->avg('price'))
                        <i class="fa fa-star"></i>
                        @else
                        <i class="fa fa-star fa fa-star-o"></i>
                        @endif
              ...
              <div class="col-md-6">
                <ul>
                  <li>Punctuality
                    <div class="rating">
                      @for($x = 0; $x < 5; $x++) @if($x < DB::table('restaurant_review')->where('restaurant_id', $restaurant->id)->avg('punctuality'))
                        <i class="fa fa-star"></i>
                        @else
                        <i class="fa fa-star fa fa-star-o"></i>
                        @endif
                  ...
                  <li>Courtesy
                    <div class="rating">
                      @for($x = 0; $x < 5; $x++) @if($x < DB::table('restaurant_review')->where('restaurant_id', $restaurant->id)->avg('courtesy'))
                        <i class="fa fa-star"></i>
                        @else
                        <i class="fa fa-star fa fa-star-o"></i>
                        @endif
          ...
          <div class="review_strip_single"> <img src="{{ URL::asset('site_assets/img/male-icon.png') }}" alt="" class="img-circle"> <small> - {{date('d F Y',$review->date)}} -</small>
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="rating">
                  @for($x = 0; $x < 5; $x++) @if($x < $review->food_quality)
                    <i class="fa fa-star"></i>
                    @else
                    <i class="fa fa-star fa fa-star-o"></i>
                    @endif
              ...
              <div class="col-md-3">
                <div class="rating">
                  @for($x = 0; $x < 5; $x++) @if($x < $review->price)
                    <i class="fa fa-star"></i>
                    @else
                    <i class="fa fa-star fa fa-star-o"></i>
                    @endif
              ...
              <div class="col-md-3">
                <div class="rating">
                  @for($x = 0; $x < 5; $x++) @if($x < $review->punctuality)
                    <i class="fa fa-star"></i>
                    @else
                    <i class="fa fa-star fa fa-star-o"></i>
                    @endif
              ...
              <div class="col-md-3">
                <div class="rating">
                  @for($x = 0; $x < 5; $x++) @if($x < $review->courtesy)
                    <i class="fa fa-star"></i>
                    @else
                    <i class="fa fa-star fa fa-star-o"></i>
                    @endif
