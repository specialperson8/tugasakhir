                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                            <li><a href="{{ url('admin/orderlist/' . $order->id . '/Pending') }}"><i
                                                        class="md md-lock"></i> Pending</a></li>
                                            <li><a href="{{ url('admin/orderlist/' . $order->id . '/Processing') }}"><i
                                                        class="md md-loop"></i> Processing</a></li>
                                            <li><a href="{{ url('admin/orderlist/' . $order->id . '/Completed') }}"><i
                                                        class="md md-done"></i> Completed</a></li>
                                            <li><a href="{{ url('admin/orderlist/' . $order->id . '/Cancel') }}"><i
                                                        class="md md-cancel"></i> Cancel</a></li>
                                            <li><a href="{{ url('admin/orderlist/' . $order->id) }}"><i
