...
@section('content')
    ...
    <div id="main">
        <div class="page-header">
            ...
            <a href="{{ URL::to('admin/restaurants/view/' . $restaurant_id . '/menu') }}"
                class="btn btn-default-light btn-xs"><i class="md md-backspace"></i> Back</a>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                {!! Form::open([
                    'url' => ['admin/restaurants/view/' . $restaurant_id . '/menu/addmenu'],
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Menu Kategori</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Nama Menu</label>
                    <div class="col-sm-9">
                        <input type="text" name="menu_name"
                            value="{{ isset($menu->menu_name) ? $menu->menu_name : null }}" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input id="touch-spin-2" data-toggle="touch-spin" data-min="-1000000" data-max="1000000"
                            data-prefix="Rp" data-step="1" type="text"
                            value="{{ isset($menu->price) ? $menu->price : null }}" name="price" class="form-control" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="avatar" class="col-sm-3 control-label">Gambar Menu</label>
                    <div class="col-sm-9">
                        <div class="media">
                            <div class="media-left">
                                @if (isset($menu->menu_image))
                                    <img src="{{ URL::asset('upload/menu/' . $menu->menu_image . '-s.jpg') }}"
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                        <button type="submit"
                            class="btn btn-primary">{{ isset($menu->id) ? 'Edit Menu ' : 'Add Menu' }}</button>
